...
| 训练后 |  {
  ...
  },
  {
    ...
    slug: "core-training",
    title: "核心训练完全指南",
    titleEn: "Complete Core Training Guide",
    category: "specialized",
    categoryZh: "专项训练",
    categoryEn: "Specialized Training",
    summary: "核心不只是腹肌，是身体的动力链中心。",
    summaryEn: "Core is more than abs, it is the power chain center of the body.",
    content: "核心训练内容...",
    contentEn: "Core training content...",
    tags: ["core", "training"],
    relatedExercises: ["plank"],
    isPremium: true,
    createdAt: "2026-04-13",
  },
  {
    ...
    slug: "stretching",
    title: "拉伸与柔韧性",
    titleEn: "Stretching and Flexibility",
    category: "training_principle",
    categoryZh: "训练原理",
    categoryEn: "Training Principles",
    summary: "柔韧性训练是完整训练计划的重要组成部分。",
    summaryEn: "Flexibility training is an important part of a complete training program.",
    content: "拉伸内容...",
    contentEn: "Stretching content...",
  ...
  },
  {
    ...
    slug: "supplements",
    title: "补剂完全指南",
    titleEn: "Complete Supplements Guide",
    category: "training_principle",
    categoryZh: "训练原理",
    categoryEn: "Training Principles",
    summary: "科学使用运动营养补剂。",
    summaryEn: "Scientific use of sports nutrition supplements.",
    content: "补剂内容...",
    contentEn: "Supplements content...",
    tags: ["supplements"],
    relatedExercises: [],
    isPremium: true,
    createdAt: "2026-04-13",
  },
  {
    ...
    slug: "home-workout",
    title: "居家健身完全指南",
    titleEn: "Complete Home Workout Guide",
    category: "population_guide",
    categoryZh: "人群指南",
    categoryEn: "Population Guides",
    summary: "在家打造完美身材。",
    summaryEn: "Build your perfect body at home.",
    content: "居家健身内容...",
    contentEn: "Home workout content...",
    tags: ["home", "workout"],
  ...
  },
  {
    ...
    slug: "running",
    title: "跑步完全指南",
    titleEn: "Complete Running Guide",
    category: "specialized",
    categoryZh: "专项训练",
    categoryEn: "Specialized Training",
    summary: "从入门到马拉松。",
    summaryEn: "From beginner to marathon.",
    content: "跑步内容...",
    contentEn: "Running content...",
    tags: ["running"],
    relatedExercises: ["running"],
    isPremium: false,
    createdAt: "2026-04-13",
  },];
