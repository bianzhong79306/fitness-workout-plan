...
CREATE TABLE IF NOT EXISTS users (
  ...
  fitness_goal TEXT,
  fitness_level TEXT,
  membership_tier TEXT DEFAULT 'free',  -- 只支持 'free' 或 'pro'
...
CREATE TABLE IF NOT EXISTS membership_tiers (
  id TEXT PRIMARY KEY,  -- 'free' 或 'pro'
  name TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS user_subscriptions (
  id TEXT PRIMARY KEY,
  user_id TEXT NOT NULL,
  tier_id TEXT NOT NULL,  -- 'free' 或 'pro'
...
CREATE TABLE IF NOT EXISTS community_posts (
  ...
  post_type TEXT DEFAULT 'general',  -- 'general', 'question', 'share'
  workout_id TEXT,
  plan_id TEXT,
